...
def render_env(source_root: Path, detection: Detection) -> str:
    ...
    values.update(
        {
            ...
            "TASKCTL_DEFAULT_SPEED_PROFILE": values.get("TASKCTL_DEFAULT_SPEED_PROFILE", "quality"),
            "TASKCTL_PROMPT_PROFILE": values.get("TASKCTL_PROMPT_PROFILE", "full"),
            "TASKCTL_SESSION_CONTEXT_PROFILE": values.get("TASKCTL_SESSION_CONTEXT_PROFILE", "compact"),
            "TASKCTL_INTERACTIVE_SPEED_PROFILE": values.get("TASKCTL_INTERACTIVE_SPEED_PROFILE", "quality"),
            "TASKCTL_INTERACTIVE_ASYNC": values.get("TASKCTL_INTERACTIVE_ASYNC", "0"),
            ...
            "ASSETGEN_FAST": values.get("ASSETGEN_FAST", "0"),
            "ASSETGEN_REUSE_EXISTING": values.get("ASSETGEN_REUSE_EXISTING", "0"),
    ...
    preferred_order = [
        ...
        "TASKCTL_DEFAULT_SPEED_PROFILE",
        "TASKCTL_PROMPT_PROFILE",
        "TASKCTL_SESSION_CONTEXT_PROFILE",
        "TASKCTL_INTERACTIVE_SPEED_PROFILE",
        "TASKCTL_INTERACTIVE_ASYNC",
        "ASSETGEN_CODEX_SANDBOX",
        "ASSETGEN_CODEX_MODEL",
        "ASSETGEN_CODEX_TIMEOUT",
        "ASSETGEN_PROGRESS_HEARTBEAT_SECONDS",
        "ASSETGEN_FAST",
        "ASSETGEN_REUSE_EXISTING",
