...
8a. When command syntax is unclear, run `taskctl.py command <name> --workspace <project>` or `taskctl.py doctor --workspace <project>` instead of guessing or reading source. Hooks include `next_command` and `command_contract` fields on blocks.
